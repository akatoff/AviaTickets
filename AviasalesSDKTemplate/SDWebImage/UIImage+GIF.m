...
+ (UIImage *)sd_animatedGIFNamed:(NSString *)name
{
    ...
    if (scale > 1.0f)
    {
        NSString *retinaPath = [AVIASALES_BUNDLE pathForResource:[name stringByAppendingString:@"@2x"] ofType:@"gif"];
        ...
        NSString *path = [AVIASALES_BUNDLE pathForResource:name ofType:@"gif"];
