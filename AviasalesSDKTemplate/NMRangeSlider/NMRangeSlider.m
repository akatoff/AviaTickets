...
- (UIImage *)trackBackgroundImage
{
    if(_trackBackgroundImage==nil)
    {
        if(IS_PRE_IOS7())
        {
            UIImage* image = [UIImage imageNamed:@"AviasalesSDKTemplateBundle.bundle/slider-default-trackBackground.png"];
            image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0.0, 5.0, 0.0, 5.0)];
            _trackBackgroundImage = image;
        }
        else
        {
            UIImage* image = [UIImage imageNamed:@"AviasalesSDKTemplateBundle.bundle/slider-default7-trackBackground.png"];
...
- (UIImage *)trackImage
{
    if(_trackImage==nil)
    {
        if(IS_PRE_IOS7())
        {
            UIImage* image = [UIImage imageNamed:@"AviasalesSDKTemplateBundle.bundle/slider-default-track.png"];
        ...
        else
        {
            ...
            UIImage* image = [UIImage imageNamed:@"AviasalesSDKTemplateBundle.bundle/slider-default7-track.png"];
            image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0.0, 2.0, 0.0, 2.0)];
...
- (UIImage *)lowerHandleImageNormal
{
    if(_lowerHandleImageNormal==nil)
    {
        if(IS_PRE_IOS7())
        {
            UIImage* image = [UIImage imageNamed:@"AviasalesSDKTemplateBundle.bundle/slider-default-handle.png"];
            _lowerHandleImageNormal = image;
        }
        else
        {
            UIImage* image = [UIImage imageNamed:@"AviasalesSDKTemplateBundle.bundle/slider-default7-handle.png"];
            _lowerHandleImageNormal = image;
        }
...
- (UIImage *)upperHandleImageHighlighted
{
    if(_upperHandleImageHighlighted==nil)
    {
        if(IS_PRE_IOS7())
        {
            UIImage* image = [UIImage imageNamed:@"AviasalesSDKTemplateBundle.bundle/slider-default-handle-highlighted.png"];
...
- (CGRect)thumbRectForValue:(float)value image:(UIImage*) thumbImage
{
    ...
    thumbRect.size = CGSizeMake(28.0f, thumbImage.size.height);
    ...
    thumbRect.origin = CGPointMake(xValue, (self.bounds.size.height/2.0f) - (thumbRect.size.height/2.0f) + 1.0f);
...
- (void) addSubviews
{
    ...
    self.lowerHandle.clipsToBounds = NO;
    ...
    self.upperHandle.clipsToBounds = NO;
