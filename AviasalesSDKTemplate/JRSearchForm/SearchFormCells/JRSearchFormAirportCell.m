...
- (void)setupAirportLabelWithIATA:(NSString *)iata item:(JRSearchFormItem *)item
{
    ...
    JRAirportPickerAirportObject *airport = [ASInitialAirportsManager getAirportObjectByIATA:iata];
	...
	if (iata) {
		...
		NSString *airportNameString = [airport.localizedAirportName uppercaseString];
