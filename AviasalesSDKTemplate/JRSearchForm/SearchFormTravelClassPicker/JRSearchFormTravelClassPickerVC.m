...
- (void)rebuildTable
{
    ...
    [_items addObject:@(JRTravelClassEconomy)];
    [_items addObject:@(JRTravelClassPremiumEconomy)];
    [_items addObject:@(JRTravelClassBusiness)];
    [_items addObject:@(JRTravelClassFirst)];
...
{
    JRTravelClass travelClass = [_items[indexPath.row] integerValue];
